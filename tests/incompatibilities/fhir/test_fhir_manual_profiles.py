...
def test_patient_profile_incompatibilities():
    ...
    assert not reasoner.check_compatibility(USPatient, NHSPatient)
    print(reasoner.explain_incompatibilities(USPatient, NHSPatient))

if __name__ == '__main__':
    test_patient_profile_incompatibilities()